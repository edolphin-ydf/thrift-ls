...
type ThriftVisitor interface {
	...
	VisitNamespace_(ctx *Namespace_Context) interface{}
	...
	VisitTypedef_(ctx *Typedef_Context) interface{}
	...
	VisitStruct_(ctx *Struct_Context) interface{}

	// Visit a parse tree produced by ThriftParser#union_.
	VisitUnion_(ctx *Union_Context) interface{}
