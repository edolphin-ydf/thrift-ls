...
func (v *BaseThriftVisitor) VisitInclude_(ctx *Include_Context) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseThriftVisitor) VisitNamespace_(ctx *Namespace_Context) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseThriftVisitor) VisitTypedef_(ctx *Typedef_Context) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseThriftVisitor) VisitStruct_(ctx *Struct_Context) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseThriftVisitor) VisitUnion_(ctx *Union_Context) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseThriftVisitor) VisitFunction_(ctx *Function_Context) interface{} {
	return v.VisitChildren(ctx)
}
